...
RevampKey is based on [Visual Studio Code - Open Source](https://github.com/microsoft/vscode) (MIT License).

```
Copyright (c) 2024 - present Rev AI Pvt Ltd
Copyright (c) 2015 - present Microsoft Corporation

This software includes code from Visual Studio Code (Code - OSS),
